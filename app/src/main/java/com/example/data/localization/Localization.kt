...
object ArabicStrings : Strings {
    ...
    override val storeNameLabel = "اسم المتجر"
    ...
    override val cleanDatabaseConfirm = "هل أنت متأكد من رغبتك في مسح جميع بيانات قاعدة البيانات؟"
    override val databaseCleanedSuccess = "تم تنظيف قاعدة البيانات بنجاح"
    override val cleanDatabaseConfirmBtn = "مسح قاعدة البيانات"
    ...
    override val databaseActiveStatus = "قاعدة البيانات نشطة"

}

object EnglishStrings : Strings {
    override val tabReports = "Reports"
    override val tabDataReports = "PDF Reports"
    ...
    override val cleanDatabaseConfirmBtn = "Clear database"
    ...
    override val databaseActiveStatus = "Database active"
